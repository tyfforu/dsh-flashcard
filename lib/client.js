...
function FlashcardView(props) {
  ...
  const s2 = {
    ...
    card: { width: "100%", maxWidth: "208px", minHeight: "300px", border: "0.5px solid var(--color-border-secondary, #ccc)", borderRadius: "16px", padding: "24px 18px", cursor: "pointer", background: "var(--color-background-secondary, #fafafa)", boxShadow: "0 6px 18px rgba(0,0,0,0.10)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center" },
    tag: { fontSize: "11px", color: "var(--color-text-tertiary, #999)", marginBottom: "10px" },
    q: { fontSize: "16px", fontWeight: "500", lineHeight: "1.6" },
