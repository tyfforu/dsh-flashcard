...
function FlashcardView(props) {
  ...
  const s2 = {
    ...
    card: { width: "100%", maxWidth: "264px", minHeight: "384px", border: "0.5px solid var(--color-border-secondary, #ccc)", borderRadius: "16px", padding: "26px 20px", cursor: "pointer", background: "var(--color-background-secondary, #fafafa)", boxShadow: "0 6px 18px rgba(0,0,0,0.10)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center" },
    tag: { fontSize: "11px", color: "var(--color-text-tertiary, #999)", marginBottom: "12px" },
    q: { fontSize: "17px", fontWeight: "500", lineHeight: "1.6" },
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: s2.wrap, children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: s2.row, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { style: s2.gear, title: "\u8BBE\u7F6E", onClick: () => setShowSettings(true), children: "\u8BBE\u7F6E" })
    ] }),
    ...
    card === void 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: s2.cardRegion, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: s2.empty, children: deck === "" ? "\u8FD8\u6CA1\u6709\u724C\u7EC4\u3002\u53BB\u804A\u5929\u6846\u8BF4\u300C\u628A XX \u505A\u6210\u95EA\u5361\u300D\uFF0C\u6216\u70B9\u4E0B\u9762\u7684\u300C\u751F\u6210\u95EA\u5361\u300D\u3002" : "\u672C\u724C\u7EC4\u6682\u65E0\u5230\u671F\u5361\u7247\uFF0C\u4F11\u606F\u4E00\u4E0B\u6216\u590D\u4E60\u5176\u4ED6\u724C\u7EC4\u3002" }) }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: s2.cardRegion, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: s2.card, onClick: () => setFlipped((f) => !f), children: [
    ...
    card !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: s2.divider }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: s2.row, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: s2.gradeGrid, children: GRADE_BUTTONS.map((g) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
        "button",
        {
          ...
          style: { ...s2.gradeBtn, background: g.bg, color: g.fg },
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: g.label }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: s2.gradeHint, children: g.hint })
          ]
        },
        g.rating
      )) }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: s2.row, children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { style: { ...s2.quickBtn, color: "#1e7a1e" }, onClick: () => mark(true), children: "\u5BF9" }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { style: { ...s2.quickBtn, color: "#b91c1c" }, onClick: () => mark(false), children: "\u9519" }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { style: { ...s2.quickBtn, flex: 1.6, background: "var(--color-background-secondary, #f0f0f0)" }, onClick: askAI, children: "\u95EE AI" })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: s2.row, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { style: s2.generateBtn, onClick: generateCards, children: "\uFF0B \u4ECE\u6587\u6863\u751F\u6210\u95EA\u5361" }) }),
